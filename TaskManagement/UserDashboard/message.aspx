    ...
    <div class="message-dashboard">
        <div class="user-container">
            ...
            <asp:Repeater ID="rpUser" runat="server" onitemcommand="rpUser_ItemCommand" >
                <ItemTemplate>
                    <div class="user">
                    <asp:LinkButton ID="lbChatOpen" CommandName="Click" CommandArgument='<%# Eval("id") %>' CssClass="link-user" runat="server">
                    <div class="user-img">
                        <img src="" alt=""/>
                    </div>
                    <div class="user-name"><asp:Label ID="lblUserName" runat="server" Text='<%# Eval("name") %>'/></div>
                    </asp:LinkButton></div></ItemTemplate></asp:Repeater></div><div class="chat-container">
            <div class="chat-header">
                <div class="user-img">
                    <img src="" alt=""/> </div><div class="user-name"> <asp:Label ID="lblUserName" runat="server" /> </div>
            </div>
            <!-- <div class="chat-box"> -->
                        ...
                        <asp:Repeater ID="rpChat" runat="server">
                            <ItemTemplate>
                                <div class='<%# Convert.ToInt32(Eval("sender_id")) == Convert.ToInt32(Session["userId"]) ? "box sender" : "box receiver" %>'>
                                    ...
                                    <div class="time"> <%# Eval("created_at","{0:hh:mm tt}") %> </div>
                                </div>
                            </ItemTemplate>
                        </asp:Repeater>
                    </ContentTemplate>
